...
var sprytextfield4 = new Spry.Widget.ValidationTextField("fnameTextField", "custom", {hint:"First Name"});
var sprytextfield5 = new Spry.Widget.ValidationTextField("usernameTextField", "custom", {hint:"Username"});
var sprytextfield6 = new Spry.Widget.ValidationTextField("lnameTextField", "custom", {hint:"Last Name"});
